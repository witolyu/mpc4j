...
public interface Zn {
     ...
     * 计算Zn元素向量a和布尔向量b的内积。
     *
     * @param znVector     Zn元素向量。
     * @param binaryVector 布尔向量。
     * @return 内积结果。
     */
    BigInteger innerProduct(final BigInteger[] znVector, final boolean[] binaryVector);
    ...
    /**
     * Create m nonzero random elements。
     *
     * @param seed 种子。
     * @param m number of elements。
     * @return 非0随机元素。
     */
    BigInteger[] createMultipleNonZeroRandom(byte[] seed, int m);
