 ...
 * @date 2022/10/28
 */
public class Ghll22OtPsuClient extends AbstractPsuClient {
    /**
     * 核COT协议接收方
     */
    ...
    public Ghll22OtPsuClient(Rpc clientRpc, Party serverParty, Ghll22OtPsuConfig config) {
        super(Ghll22OtPsuPtoDesc.getInstance(), clientRpc, serverParty, config);
