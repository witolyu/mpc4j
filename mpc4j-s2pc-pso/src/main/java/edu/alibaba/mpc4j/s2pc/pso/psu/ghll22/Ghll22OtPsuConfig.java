 ...
 * @date 2022/10/28
 */
public class Ghll22OtPsuConfig implements PsuConfig {
    /**
     * 核COT协议配置项
     */
    ...
    private Ghll22OtPsuConfig(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<Ghll22OtPsuConfig> {
        /**
         * 核COT协议配置项
         */
        ...
        @Override
        public Ghll22OtPsuConfig build() {
            return new Ghll22OtPsuConfig(this);
        }
    }
}
